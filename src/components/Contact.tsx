  ...
  const contactMethods = [
    {
      ...
      label: "Instagram",
      value: "@valensnatch",
      href: "https://instagram.com/valensnatch/"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: "WhatsApp",
      value: "+51 992 592 765",
      href: "https://api.whatsapp.com/send/?phone=992592765&text&type=phone_number&app_absent=0"
    },
    {
      icon: (
      ...
      label: "Email",
      value: "valennsanto13@gmail.com",
      href: "mailto:valennsanto13@gmail.com"
    }
  ];
            ...
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                <div className="ml-4 flex-1">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 group-hover:text-contrast-dark-rose dark:group-hover:text-pastel-blush transition-colors duration-300">
                    {method.label}
                  </h3>
                ...
                <div className="flex-shrink-0">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-contrast-dark-rose dark:group-hover:text-pastel-blush group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
